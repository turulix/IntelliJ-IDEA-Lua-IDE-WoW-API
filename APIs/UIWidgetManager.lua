...
---@param widgetID number 
---@return MapPinAnimationWidgetVisualizationInfo|nil widgetInfo
...
---@param widgetID number 
---@return ScenarioHeaderDelvesWidgetVisualizationInfo|nil widgetInfo
...
---@class SpellDisplayTint
SpellDisplayTint = {}
SpellDisplayTint.None = 0
SpellDisplayTint.Red = 1
...
---@class UIWidgetOverrideState
UIWidgetOverrideState = {}
UIWidgetOverrideState.Inactive = 0
UIWidgetOverrideState.Active = 1

---@class UIWidgetRewardShownState
...
UIWidgetTextureAndTextSizeType.Medium2 = 5
...
WidgetEnabledState.BrightBlue = 7
...
---@field tierTooltipSpellID number|nil 
---@field currencies UIWidgetCurrencyInfo 
