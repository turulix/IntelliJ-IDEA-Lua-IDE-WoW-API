...
---@return GossipOptionUIWidgetSetAndType|nil gossipOptionUIWidgetSetsAndTypes
...
---@class GossipOptionUIWidgetSetTypes
GossipOptionUIWidgetSetTypes = {}
GossipOptionUIWidgetSetTypes.Modifiers = 0
GossipOptionUIWidgetSetTypes.Background = 1
